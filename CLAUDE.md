...
**포함:** 서울 1맵·S자 경로 1개 / N서울타워(고정) + 랜드마크 5(자동 해금) / 서포터 2 / 장애물 2 / 부가효과 3 / 정책 5 / 적 3 + 보스 / 레벨업 드래프트 3장·골드 강화·보스 정책 3채널 / 유니크 룰·상성 특효·조명 체력·하늘 틴트 / 계절 4 / 날짜 시드·계절 반영 / 낮·밤 배경(5웨이브 주기 전환) / 배속·즉시웨이브·사거리표시·디버그 / 역사 변천(색조+자막)
